    ...
    try {
      const res = await fetch("/api/generate", {
        ...
        body: JSON.stringify({
          ...
          style,
          context,
          referenceImages: refs.map(({ data, mimeType }) => ({
            data,
            mimeType,
          })),
        }),
        ...
        >
          <div>
            <h1 className="font-display font-bold text-2xl">
              Generate <span className="gradient-text">image</span>
            </h1>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              placeholder="A red panda astronaut floating above a neon city at dusk"
          ...
          <div>
            <label className="block text-xs uppercase tracking-widest text-white/60 mb-2">
              Context <span className="text-white/30 normal-case">(optional)</span>
            </label>
            <textarea
              value={context}
